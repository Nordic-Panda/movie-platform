...
5. FluentValidation. Tool to run validation in ApiController. It does not replace domain validation cause FluentValidation only triggers if request is coming from Api, ignoring internal creation.
