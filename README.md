...
10. Joint Table does not need to an own entity if there is no additional info, for example MovieActors has character name, while Movie and Genre is only a relation
